...
\scnidtf{Список связанных с родительским sc-элементом sc-элементов, их коннекторов и модификаторы}
\scntext{примечание}{Данный список содержит объекты которые описывают трехэлементные sc-конструкци или пятиэлементные sc-конструкции при помощи 3-х списков коннекторов, модификаторов, связанных sc-элементов сгруппированных по модификаторам}
...
\scntext{пояснение}{Текущая реализация sc-агента осуществляет транлсяцию из внутреннего представления знаний в формат scn (json), позволяющий отобразить полученную структуру без допольнительных преобразований, в отличии от формата scs (json).}
